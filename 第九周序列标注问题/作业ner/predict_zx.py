...
class XPredict():
    ...
    def predict(self,sequences):
        for text in sequences:
            ...
            input_id = self.tokenizer.encode(text_list, padding='max_length', max_length=self.config["max_length"], truncation=True)
...
if __name__ == '__main__':
    ...
    xPredict = XPredict(Config,"model_output/epoch_50.pth")
    xPredict.predict([
