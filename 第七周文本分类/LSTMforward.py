...
'''
weight_ih_l0 torch.Size([28, 12]) 4个门 4*7   ih input * hidden
weight_hh_l0 torch.Size([28, 7])             hh  hidden * hidden
...
# torch_sequence_output 每个字输出的向量
...
print("--------")
print("torch_h:",torch_h)
print("numpy_h",numpy_h)
print("--------")
