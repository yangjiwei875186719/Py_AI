"""
使用RNN判断某一个字出现的位置,此例子是判断"你"字的位置
"""
import random
...
# 1.创建词汇表
def build_vocab():
    chars = "rsqpo在家你i红kejyw国nuvxgdlcahfmtbz"
    vocab = {}
...
#     main()
#     # input_str = ['fegdkm红uraov在qjz国txi家你wyhcbsnlp',
#     #              'rdt红ngye国cijzxlhwof在k你ubmaqsv家p',
#     #              'syi你xwcudpaqgmok国ftzjre红blnv在家h',
#     #              '家国f你jgcvitdulqn在红rboxzehawpyksm',
#     #              'nmbkuzsl国rcq你tjyif在xaoghpewd家v红',
#     #              'hald红cynwe国gjbzfxpksqr家你oiu在tmv',
#     #              'n国s在yhpklxe红家qzua你irbwgojtvdmcf',
#     #              '你红yktdov国sngmhuarlz在feqjib家pcwx',
#     #              'wtmnsgyoxluq红faich你dpjr在k国家bezv',
#     #              '在qvn红iejkphdobmw国tx你gcrualyzfs家']
#     #
